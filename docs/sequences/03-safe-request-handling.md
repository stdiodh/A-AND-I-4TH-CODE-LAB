...
- 애플리케이션 context와 Validation 관련 bean이 정상적으로 올라오는지 확인합니다.
- 잘못된 요청의 400 응답과 에러 응답 형식은 Swagger에서 직접 확인합니다.
- DTO validation과 Service 비즈니스 예외의 책임 차이는 코드와 실행 결과로 확인합니다.
...
- context 테스트가 통과합니다.
- Swagger에서 잘못된 요청의 400 응답과 에러 JSON을 확인했습니다.
- 실패 응답을 읽고 DTO 검증 문제와 예외 처리 문제를 구분할 수 있습니다.
