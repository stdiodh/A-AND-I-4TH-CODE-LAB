...
**왜 메모리 저장이 부족한지**, **왜 Repository가 필요한지**, **왜 계층을 나누는지**를
...
**메모리 저장을 MySQL 저장으로 교체하고 CRUD를 확장하는 것**에 집중합니다.
...
즉 `02`의 실무 확장 개념은
**문제 이름 소개**가 아니라
**문제 코드와 해결 코드까지 같이 읽는 입문 단계**로 설계합니다.
